...
allseen = set()
rangex = range(min(map(itemgetter(0), cubes)),
               max(map(itemgetter(0), cubes)) + 1)
rangey = range(min(map(itemgetter(1), cubes)),
               max(map(itemgetter(1), cubes)) + 1)
rangez = range(min(map(itemgetter(2), cubes)),
               max(map(itemgetter(2), cubes)) + 1)
